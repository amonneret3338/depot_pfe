...
Le stage est réalisé au sein du \textbf{Service de Génie Logiciel pour la Simulation (SGLS)} du CEA, dont les activités visent à développer
et maintenir des compétences de pointe dans les domaines du génie
logiciel, de la simulation numérique et du calcul intensif. Le service
accompagne les équipes métiers du CEA dans le développement, la
maintenance et l'optimisation de leurs outils de simulation, tout en
contribuant à leur adaptation aux architectures de calcul.

Le SGLS s'appuie notamment sur plusieurs domaines de compétence :
le génie logiciel et les outils de développement, les outils de
maillage et de visualisation, le couplage de codes multiphysiques et
multi-échelles, le calcul intensif (\textit{HPC}), l'analyse numérique,
ainsi que les méthodes de science des données et d'intelligence
artificielle appliquées à la simulation.

Cette activité repose sur une articulation entre recherche et
développement amont et implémentation opérationnelle, ainsi qu'entre
plateformes génériques et outils dédiés aux applications métiers.
Le service est organisé autour de plusieurs laboratoires, dont le
\textbf{LESIM}, spécialisé dans les environnements de simulation,
les maillages, le pré- et post-traitement et le couplage de codes,
et le \textbf{LCAN}, dédié au calcul intensif et à l'analyse
numérique. Cette organisation favorise la transversalité et le
travail en interaction avec les équipes métiers du CEA.

Le stage s'inscrit ainsi dans les activités du service liées au
développement d'outils de simulation numérique et à leur intégration
dans des plateformes de calcul multiphysique.
