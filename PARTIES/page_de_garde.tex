...
\begin{titlepage}
    ...
    { \Huge\bfseries Vérification et validation de quelques modèles de transfert radiatif \\   pour TRUST/TrioCFD \par}
    {\large du 30/03/26 au 28/08/26\par}
    ...
    \vspace{0.2 cm}
    \leftline{\large {\textcolor{gray}{http://phelma.grenoble-inp.fr}}}}
