...
\begin{figure}[H]
\centering
\includegraphics[width=0.52\linewidth]{PICTURES/c5couplage/hot_spot.pdf}
\caption{Modéle de l'écart de la température maximale par rapport à la température moyenne.}
\label{fig:hotspot}
\end{figure}
