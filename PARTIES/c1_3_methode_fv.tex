...
La diversité des méthodes restantes illustrée par le Tableau~\ref{tab:methods} ne sera pas abordée en profondeur. La méthode retenue pour ce travail est la méthode de Monte Carlo Ray Tracing qui est reconnue pour sa généricité. Deux autres méthodes sont néanmoins présentées dans la suite de cette section, afin de comprendre comment sont établis les facteurs de vue pour des géométries simples.
