...
\begin{figure}[H]
    ...
    \caption{Principe d'une \emph{Bounding Volume Hierarchy} (BVH). Les triangles sont regroupés dans une hiérarchie de boîtes englobantes permettant d'éliminer rapidement les régions de l'espace non traversées par un rayon.}
    \label{fig:bvh}
\end{figure}
